                    ...
                    <form class="box-body container-fluid d-flex align-items-end row" method="" action="<?php echo substr($url_current, 0, -1).'/1';  ?>"></br>
                        <div class="col-md-12">
                            <div class="form-group col-md-1 ">
                                ...
                                <input class="form-control" type="text" name="id" value="<?php echo  (isset($_GET['id'])) ? $_GET['id']:''; ?>" id="id">
                            </div><div class="form-group col-md-2">
                                <label for="Nom">Nom</label>
                                <input class="form-control" type="text" name="nom" value="<?php echo  (isset($_GET['nom'])) ? $_GET['nom']:''; ?>" id="Nom">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="prenom">Prénom</label>
                                <input class="form-control" type="text" name="prenom" value="<?php echo (isset($_GET['prenom'])) ? $_GET['prenom']:''; ?>" id="prenom">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="code_postal">Code postal</label>
                                <input class="form-control" type="text" name="code_postal" value="<?php echo (isset($_GET['code_postal'])) ? $_GET['code_postal']:''; ?>" id="code_postal">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="ville">Ville</label>
                                <input class="form-control" type="text" name="ville" value="<?php echo (isset($_GET['ville'])) ? $_GET['ville']:''; ?>" id="ville">
                            </div>
                            <div class=" form-group col-md-2">
                                <label for="email">Email</label>
                                <input class="form-control" type="text" name="email" value="<?php echo (isset($_GET['email'])) ? $_GET['email']:''; ?>" id="email">
                            </div>
