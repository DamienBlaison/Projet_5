        ...
        <aside class="main-sidebar">
            <section class="sidebar" style="min-height: 100%; height:100%;">
                ...
                <ul class="sidebar-menu tree" data-widget="tree">
                    ...
                    <li class="active treeview menu-open">
                        <a href="#"><i class="fa  fa-euro"></i> <span>Les dons</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                        <ul class="treeview-menu">
                            <li><a href="/www/Kalaweit/donation/add"><i class="fa  fa-plus-square"></i> Ajouter un don</a></li>
                            <li><a href="/www/Kalaweit/asso_cause/list/1"><i class="fa  fa-folder-open"></i> Tous les dons</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
